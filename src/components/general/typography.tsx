...
const typographyVariants = cva('text-gray-600 text-normal', {
  variants: {
    variant: {
      h1: 'font-display text-4xl font-bold md:text-5xl md:tracking-[-0.02em] lg:text-6xl lg:leading-[72px] text-gray-900',
      h2: 'font-display text-lg md:text-4xl font-bold tracking-[-0.02em] text-gray-900',
      h3: 'font-display text-2xl md:text-3xl font-bold tracking-[-0.02em] text-gray-900',
